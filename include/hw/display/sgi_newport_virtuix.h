...
#ifndef HW_DISPLAY_SGI_NEWPORT_VIRTUIX_H
#define HW_DISPLAY_SGI_NEWPORT_VIRTUIX_H
...
#define TYPE_SGI_NEWPORT_VIRTUIX "sgi-newport-virtuix"
OBJECT_DECLARE_SIMPLE_TYPE(SGINewportVirtuixState, SGI_NEWPORT_VIRTUIX)
