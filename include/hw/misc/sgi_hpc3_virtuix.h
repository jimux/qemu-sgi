...
#ifndef HW_MISC_SGI_HPC3_VIRTUIX_H
#define HW_MISC_SGI_HPC3_VIRTUIX_H
 ...
 */
#define TYPE_SGI_PS2_KBD_VIRTUIX "sgi-ps2-kbd-virtuix"
OBJECT_DECLARE_SIMPLE_TYPE(SGIPs2KbdVirtuixState, SGI_PS2_KBD_VIRTUIX)

struct SGIPs2KbdVirtuixState {
...
#define TYPE_SGI_HPC3_VIRTUIX "sgi-hpc3-virtuix"
OBJECT_DECLARE_SIMPLE_TYPE(SGIHPC3VirtuixState, SGI_HPC3_VIRTUIX)
...
#define SCC_RX_FIFO_SIZE 16
     ...
     */
    SGIPs2KbdVirtuixState ps2kbd;        /* PS/2 keyboard device (SGI typematic subtype) */
