...
struct target_termios {
    ...
    target_cc_t c_line;                    /* line discipline (unused on IRIX) */
#ifdef IRIX_NEW_TERMIO
    target_tcflag_t c_ospeed;
    target_tcflag_t c_ispeed;
#endif
...
#define TARGET_EXTPROC 0200000  /* not present on IRIX; for shared strace */
...
#define TARGET_TIOCGPTPEER 0x7441	/* Linux-only; not issued by IRIX */
