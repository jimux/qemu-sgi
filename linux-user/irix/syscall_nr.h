...
/*
 * Linux-only syscall numbers referenced by the shared linux-user/syscall.c
 * switch but with no IRIX equivalent. Defined as distinct out-of-band values
 * (>= 3000) so the case labels compile; IRIX guest binaries never issue these
 * numbers (real IRIX syscalls dispatch through TARGET_NR_Linux + index).
 * Ported from qemu-irix lineage (Kai-Uwe Bloem; n64decomp/qemu-irix), GPLv2.
 */
#define TARGET_NR_LINUX_COMPAT_BASE 3000
#define TARGET_NR_capget        (TARGET_NR_LINUX_COMPAT_BASE + 0)
#define TARGET_NR_capset        (TARGET_NR_LINUX_COMPAT_BASE + 1)
#define TARGET_NR_clone         (TARGET_NR_LINUX_COMPAT_BASE + 2)
#define TARGET_NR_epoll_pwait   (TARGET_NR_LINUX_COMPAT_BASE + 3)
#define TARGET_NR_epoll_pwait2  (TARGET_NR_LINUX_COMPAT_BASE + 4)
#define TARGET_NR_execveat      (TARGET_NR_LINUX_COMPAT_BASE + 5)
#define TARGET_NR_exit_group    (TARGET_NR_LINUX_COMPAT_BASE + 6)
#define TARGET_NR_flock         (TARGET_NR_LINUX_COMPAT_BASE + 7)
#define TARGET_NR_getcpu        (TARGET_NR_LINUX_COMPAT_BASE + 8)
#define TARGET_NR_getcwd        (TARGET_NR_LINUX_COMPAT_BASE + 9)
#define TARGET_NR_getgroups     (TARGET_NR_LINUX_COMPAT_BASE + 10)
#define TARGET_NR_getpriority   (TARGET_NR_LINUX_COMPAT_BASE + 11)
#define TARGET_NR_getrusage     (TARGET_NR_LINUX_COMPAT_BASE + 12)
#define TARGET_NR_getsid        (TARGET_NR_LINUX_COMPAT_BASE + 13)
#define TARGET_NR_gettid        (TARGET_NR_LINUX_COMPAT_BASE + 14)
#define TARGET_NR_openat        (TARGET_NR_LINUX_COMPAT_BASE + 15)
#define TARGET_NR_openat2       (TARGET_NR_LINUX_COMPAT_BASE + 16)
#define TARGET_NR_personality   (TARGET_NR_LINUX_COMPAT_BASE + 17)
#define TARGET_NR_prctl         (TARGET_NR_LINUX_COMPAT_BASE + 18)
#define TARGET_NR_reboot        (TARGET_NR_LINUX_COMPAT_BASE + 19)
#define TARGET_NR_rt_sigaction  (TARGET_NR_LINUX_COMPAT_BASE + 20)
#define TARGET_NR_rt_sigpending (TARGET_NR_LINUX_COMPAT_BASE + 21)
#define TARGET_NR_rt_sigprocmask (TARGET_NR_LINUX_COMPAT_BASE + 22)
#define TARGET_NR_rt_sigqueueinfo (TARGET_NR_LINUX_COMPAT_BASE + 23)
#define TARGET_NR_rt_sigreturn  (TARGET_NR_LINUX_COMPAT_BASE + 24)
#define TARGET_NR_rt_sigsuspend (TARGET_NR_LINUX_COMPAT_BASE + 25)
#define TARGET_NR_rt_tgsigqueueinfo (TARGET_NR_LINUX_COMPAT_BASE + 26)
#define TARGET_NR_sched_getaffinity (TARGET_NR_LINUX_COMPAT_BASE + 27)
#define TARGET_NR_sched_getattr (TARGET_NR_LINUX_COMPAT_BASE + 28)
#define TARGET_NR_sched_get_priority_max (TARGET_NR_LINUX_COMPAT_BASE + 29)
#define TARGET_NR_sched_get_priority_min (TARGET_NR_LINUX_COMPAT_BASE + 30)
#define TARGET_NR_sched_setaffinity (TARGET_NR_LINUX_COMPAT_BASE + 31)
#define TARGET_NR_sched_setattr (TARGET_NR_LINUX_COMPAT_BASE + 32)
#define TARGET_NR_setfsgid      (TARGET_NR_LINUX_COMPAT_BASE + 33)
#define TARGET_NR_setfsuid      (TARGET_NR_LINUX_COMPAT_BASE + 34)
#define TARGET_NR_setgroups     (TARGET_NR_LINUX_COMPAT_BASE + 35)
#define TARGET_NR_setpriority   (TARGET_NR_LINUX_COMPAT_BASE + 36)
#define TARGET_NR_setsid        (TARGET_NR_LINUX_COMPAT_BASE + 37)
#define TARGET_NR_sysinfo       (TARGET_NR_LINUX_COMPAT_BASE + 38)
#define TARGET_NR_tgkill        (TARGET_NR_LINUX_COMPAT_BASE + 39)
#define TARGET_NR_tkill         (TARGET_NR_LINUX_COMPAT_BASE + 40)
#define TARGET_NR_lstat         (TARGET_NR_LINUX_COMPAT_BASE + 41)
#define TARGET_NR_fstat         (TARGET_NR_LINUX_COMPAT_BASE + 42)
#define TARGET_NR_ppoll         (TARGET_NR_LINUX_COMPAT_BASE + 43)
