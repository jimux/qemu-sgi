...
const VMStateDescription vmstate_mips_cpu = {
    ...
    .fields = (const VMStateField[]) {
        ...
        VMSTATE_INT32(env.CP0_Performance1, MIPSCPU),
        VMSTATE_INT32(env.CP0_Performance2, MIPSCPU),
        VMSTATE_INT32(env.CP0_Performance3, MIPSCPU),
        VMSTATE_INT32(env.CP0_Performance4, MIPSCPU),
        VMSTATE_INT32(env.CP0_Performance5, MIPSCPU),
        VMSTATE_INT32(env.CP0_Performance6, MIPSCPU),
        VMSTATE_INT32(env.CP0_Performance7, MIPSCPU),
